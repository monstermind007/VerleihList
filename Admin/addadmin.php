    ...
    <main>
        <div class="main_container">
            ...
            if (isset($_POST["registrierung"])) {
                ...
                $eintrag = "INSERT INTO personen (Vorname, Name, Telefon, Klasse, Straße, PLZ, Ort, EMail, Password, IstAdmin) VALUES ('$vorname', '$nachname', '$telefon', '$klasse', '$straße', '$plz', '$ort', '$email', '$passwort', '$Rechte')";
